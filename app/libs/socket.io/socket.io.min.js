...
!(function (t, e) {
  ...
  function D(t, e) {
    e.useNativeTimers
      ...
      : ((t.setTimeoutFn = P.setTimeout.bind(P)), (t.clearTimeoutFn = P.clearTimeout.bind(P)))
  }
  var F,
    M = (function (t) {
      o(i, t)
  ...
  function kt(t) {
    var e = [],
      n = t.data,
      r = t
    return (r.data = bt(n, e)), (r.attachments = e.length), { packet: r, buffers: e }
  }
  function bt(e, n) {
    if (!e) return e
    if (gt(e)) {
  ...
  var Ot,
    Et = ['connect', 'connect_error', 'disconnect', 'disconnecting', 'newListener', 'removeListener']
  !(function (t) {
          ...
          [
            {
              ...
              value: function (t) {
                ...
                if ('string' == typeof t) {
                  ...
                  var n = (e = this.decodeString(t)).type === Ot.BINARY_EVENT
                  n || e.type === Ot.BINARY_ACK
                    ? ((e.type = n ? Ot.EVENT : Ot.ACK),
              ...
              value: function (t, e) {
                switch (t) {
                  ...
                  case Ot.CONNECT_ERROR:
                    return 'string' == typeof e || Rt(e)
                  case Ot.EVENT:
                  case Ot.BINARY_EVENT:
                    return (
                      Array.isArray(e) &&
                      ('number' == typeof e[0] || ('string' == typeof e[0] && -1 === Et.indexOf(e[0])))
                    )
                  case Ot.ACK:
                  case Ot.BINARY_ACK:
        ...
        r(s, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var i = St(n, 'open', function () {
                  r.onopen(), t && t()
                }),
                o = St(n, 'error', function (n) {
                  r.cleanup(),
          ...
          },
          {
            ...
            value: function (t, e) {
              var n = this.nsps[t]
              return (
                n ? this._autoConnect && !n.active && n.connect() : ((n = new xt(this, t, e)), (this.nsps[t] = n)), n
              )
            }
          },
          {
  ...
  return i(qt, { Manager: Pt, Socket: xt, io: qt, connect: qt }), qt
})
